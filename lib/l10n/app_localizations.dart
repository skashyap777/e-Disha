...
abstract class AppLocalizations {
  ...
  /// Message when history playback is completed
  ///
  /// In en, this message translates to:
  /// **'History playback completed'**
  String get historyPlaybackCompleted;
  ...
  /// Inactive 7 days label
  ///
  /// In en, this message translates to:
  /// **'Inactive 7D'**
  String get inactive7Days;

  /// Inactive 30 days label
  ///
  /// In en, this message translates to:
  /// **'Inactive 30D'**
  String get inactive30Days;
  ...
  /// Current position marker snippet
  ///
  /// In en, this message translates to:
  /// **'Current position'**
  ...
  ///
  /// In en, this message translates to:
  /// **'{count} waypoint{plural}'**
  String waypointsCount(int count, String plural);
  ...
  /// Failed to load vehicles title
  ///
  /// In en, this message translates to:
  /// **'Failed to Load Vehicles'**
  String get failedToLoadVehicles;

  /// No vehicles found title
  ///
  /// In en, this message translates to:
  /// **'No Vehicles Found'**
  String get noVehiclesFound;

  /// Adjust search filters message
  ///
  /// In en, this message translates to:
  ...
  /// Alert management screen title
  ///
  /// In en, this message translates to:
  /// **'Alert Management'**
  String get alertManagementTitle;
  ...
  /// Device selection validation error
  ///
  /// In en, this message translates to:
